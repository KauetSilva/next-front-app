      ...
      <div className="bg-[#F6F7EB] text-[#2C2A4A]">
        ...
        <div className="flex px-44 py-4">
          <div className="w-full text-center">
            <h1 className="font-bold text-2xl w-[38rem]">
              Bem-vindo à solução definitiva para gerenciamento de entregas
              corporativas em tempo real!
            </h1>
            <p className="whitespace-pre-line text-sm opacity-60 w-[38rem]">
      ...
      <div className="bg-[#2C2A4A] text-[#F6F7EB] rounded-t-3xl">
        <div className="px-44 py-4 flex flex-col justify-between h-full">
          <div className="flex items-center justify-center text-center">
            <p className="whitespace-pre-line text-sm opacity-60 w-[15rem]">
